          ...
          <div>
            ...
            <div className="mb-16">
              <div className="flex flex-wrap justify-center -m-2.5">
                <div className={`${category === '1' && 'rotate-2'}`}>
                  <button className={`relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-linear-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '1' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300' : 'before:via-gray-600'}`} onClick={() => setCategory('1')}>
            ...
            <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-4 sm:gap-x-6 sm:gap-y-8 items-start">
              ...
              <a
                ...
                href="#0"
              >
                <div className="relative h-12 w-12 rounded-full bg-linear-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-linear-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
